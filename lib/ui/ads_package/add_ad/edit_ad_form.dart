...
class EditAdSectionsScreen extends StatefulWidget {
  final comeFrom;

  EditAdSectionsScreen({Key key, this.comeFrom}) : super(key: key);

  @override
  _EditAdSectionsScreenState createState() => _EditAdSectionsScreenState();
}

class _EditAdSectionsScreenState extends State<EditAdSectionsScreen> {
